...
public class ProfessorOperations {
	...
	public static void deleteProfessor(Connection con, int professorId) {
	...
	public static void updateProfessor(Connection con,String uprofessorName , int professorId) {
	...
	public static ArrayList<Professor> displayProfessor(Connection con){
